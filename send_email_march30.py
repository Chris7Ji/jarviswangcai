...
<head>
    <meta charset="UTF-8">
    <title>高校分队 AI 新闻每日简报 - 2026年3月30日</title>
    <style>
...
<body>
    ...
    <div class="section">
        ...
        <div class="news-item">
            <div class="news-title">腾讯汤道生：AI落地不只是算法题，Harness工程能力是关键变量<span class="badge-new">今日重大</span></div>
            <div class="news-meta">来源：53AI | 发布时间：2026-03-29 12:54</div>
            <div class="news-summary">腾讯汤道生称AI落地关键在于工程能力（Harness设计），而非仅依赖算法。腾讯混元3.0模型能力提升，通过智能体开发平台ADP、Claw系统等，结合RAG、知识库及Skill等技术，将Agent能力推广至办公场景，实现知识即时获取与应用。</div>
            <a class="news-link" href="https://www.53ai.com/news/LargeLanguageModel/2026032918349.html" target="_blank">查看原文</a>
        </div>
        
        <div class="news-item">
            <div class="news-title">最强Claude意外泄露！代号「卡皮巴拉」，完胜Opus 4.6</div>
            <div class="news-meta">来源：53AI | 发布时间：2026-03-28 05:13</div>
            <div class="news-summary">Anthropic意外泄露新模型Claude Mythos（代号卡皮巴拉），性能远超现有最强模型Opus 4.6，在多领域实现显著提升，属于闭源大模型的技术突破。</div>
            <a class="news-link" href="https://www.53ai.com/news/LargeLanguageModel/2026032874528.html" target="_blank">查看原文</a>
        </div>
        
        <div class="news-item">
            <div class="news-title">Harness：AI从"能做"到"稳做"的系统层革命</div>
    ...
    <div class="section">
        ...
        <div class="news-item">
            <div class="news-title">Claude Code开启团战模式！Agent Teams必须用起来</div>
        ...
        <div class="news-item">
            ...
            <div class="news-summary">淘宝闪购与千问合作项目中，Tair作为AI Agent短期记忆层的核心技术实践，包括数据模型设计、压缩策略及并发控制等，支持AI Agent的秒级响应。</div>
    ...
    <div class="section">
        ...
        <div class="news-item">
            <div class="news-title">腾讯汤道生：Harness工程能力是AI落地关键变量</div>
            <div class="news-meta">来源：53AI | 发布时间：2026-03-29 12:54</div>
            <div class="news-summary">腾讯汤道生强调AI落地关键在于工程能力，腾讯混元3.0通过智能体开发平台ADP、Claw系统等，将Agent能力推广至办公场景，实现知识即时获取与应用。</div>
            <a class="news-link" href="https://www.53ai.com/news/LargeLanguageModel/2026032918349.html" target="_blank">查看原文</a>
        </div>
    ...
    <div class="footer">
        ...
        <p>生成时间：2026年3月30日 06:35 (北京时间)</p>
    </div>
</body>
</html>"""
...
def send_email(to_email, subject, html_body):
    ...
    msg["From"] = EMAIL
    msg["To"] = to_email
    plain_text = "高校分队 AI 新闻每日简报 2026年3月30日\n\n请使用HTML格式查看完整内容。"
...
subject = "[2026-03-30] 高校分队 AI 新闻每日简报"
sent_count = 0
failed = []
for to in TO_EMAILS:
    try:
